...
public class All_Labs_List extends Fragment implements ObservableScrollViewCallbacks {
    ...
    public String Log_Status, str_response, tv_code_val, tv_id_val, doc_url, edit_query;
    Intent intent;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
      ...
      /*  listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                tv_code_val = tv_code.getText().toString();
                ...
                Intent i = new Intent(getActivity(), Labtest_WebViewActivity.class);
                i.putExtra("url", "");
                ...
                Model.mFirebaseAnalytics.logEvent("View_Labtest", params);
                //------------ Google firebase Analitics--------------------
...
/*
    ...
    public void full_process() {
        ...
        try {
            ...
            System.out.println("All---" + json_viewtests.toString());
    ...
    class MyTask_server extends AsyncTask<JSONObject, Void, Void> {
        ...
        protected Void doInBackground(JSONObject... params) {
            ...
            try {
                ...
                System.out.println("All str_response--------------" + str_response);
                ...
                if (json instanceof JSONObject) {
                    ...
                    if (str_response.length() > 2) {
                        ...
                        for (int i = 0; i < jsonarr.length(); i++) {
                            ...
                            objItem.setCode(jsonobj1.getString("code"));
