...
public class Thyrocare_Fragment extends Fragment implements ObservableScrollViewCallbacks {
    ...
    private class JSON_cart_list extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            try {
               ...
               // getActivity().tv_cart_count.setText("" + Model.mNotificationCounter);
