...
public class DeepLinkActivityAskDoctor extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (domain_check) {
                String sub_str_msg = "ask-a-doctor-online";
                    ...
                    if (Log_Status.equals("1")) {
                        try {
                            if ((Model.id) != null && !(Model.id).isEmpty() && !(Model.id).equals("null") && !(Model.id).equals("")) {
                                ...
                                Model.kiss.record("android.patient.DeepLink_Ask_Doctor");
                                properties.put("android.patient.Cons_id", idval);
                                Model.kiss.set(properties);
                                //--------------------Kissmetrics--------------------------

                                intent = new Intent(this, AskQuery1.class);
                            ...
                            e2.printStackTrace();
                            System.out.println("Exception-AskDoct-----" + e2.toString());
                            intent = new Intent(this, LoginActivity.class);
                            startActivity(intent);
                        }
                    } else {
