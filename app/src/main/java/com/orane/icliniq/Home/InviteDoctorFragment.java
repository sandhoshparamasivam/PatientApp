...
public class InviteDoctorFragment extends AAH_FabulousFragment {
    ...
    public static InviteDoctorFragment newInstance() {
        InviteDoctorFragment f = new InviteDoctorFragment();
        return f;
    }
...
/*
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.invite_doctors, container, false);
...
*/
    ...
    public void setupDialog(Dialog dialog, int style) {
        View view = View.inflate(getContext(), R.layout.invitedoctor_fragment, null);

        RelativeLayout rl_content = (RelativeLayout) view.findViewById(R.id.rl_content);
        LinearLayout ll_buttons = (LinearLayout) view.findViewById(R.id.ll_buttons);
        ...
        spinner_ccode = (Spinner) view.findViewById(R.id.spinner_ccode);
        edt_mobno = (EditText) view.findViewById(R.id.edt_mobno);
        edt_docname = (EditText) view.findViewById(R.id.edt_docname);
        ...
        ((TextView) view.findViewById(R.id.tv_appre1)).setTypeface(font_bold);
        ((TextView) view.findViewById(R.id.tv_req)).setTypeface(font_reg);
        ((TextView) view.findViewById(R.id.tv_docname)).setTypeface(font_bold);
        ((TextView) view.findViewById(R.id.tv_docname2)).setTypeface(font_reg);
        ((TextView) view.findViewById(R.id.tv_doc_email)).setTypeface(font_bold);
        ((TextView) view.findViewById(R.id.tv_doc_email2)).setTypeface(font_reg);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (new NetCheck().netcheck(getActivity())) {
                    ...
                    Toast.makeText(getActivity(), "Internet connection is not available, please try again.", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            try {
                ...
                if (jsonobj_invite.has("token_status")) {
                    ...
                    if (status_val.equals("1")) {
                        ...
                        params.putString("country_Code",cccode);
                        params.putString("doc_mobile",mobno);
                        params.putString("doc_name",docname);
                        params.putString("doc_email",email);
