    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (position) {
            case 0:
                ...
                viewHolder.imageView.setImageResource(R.mipmap.whatsapp_icon);
                break;
            case 1:
                viewHolder.textView.setText(context.getString(R.string.google_maps_title));
                viewHolder.imageView.setImageResource(R.mipmap.fbmsg);
                break;
            default:
                viewHolder.textView.setText(context.getString(R.string.google_messenger_title));
                viewHolder.imageView.setImageResource(R.mipmap.share_icon);
                break;
        }
